...
- **Document metadata and lineage** through a data dictionary, batch decision log, and validation summary.
...
This project addresses those problems with a compact, transparent pipeline.
...
7. Generate lineage, scorecard, and EDA artifacts for reviewer communication.
...
2. Inspect [reports/summary_report.md](reports/summary_report.md) and [reports/batch_quality_scorecard.csv](reports/batch_quality_scorecard.csv).
3. Review [data/lineage/batch_lineage.json](data/lineage/batch_lineage.json).
